...
val STRINGS_EN: Map<String, String> = mapOf(
	// Напоминание
	"app.001" to "Reminder",
	...
	"dp.011" to "Adding…",
	"dp.013" to "Deck name",
	"dp.014" to "Pronunciation",
	"dp.015" to "How the phrase sounds. English spelling is readable to almost anyone; IPA is exact.",
	"dp.016" to "English",
	"dp.017" to "IPA",
	"dp.018" to "Off",
	"dp.019" to "No line is shown",
	...
	"cat.008" to "Meanings in",
	"cat.009" to "Topic",
	"cat.010" to "Level",
	"cat.011" to "ALL",
	"cat.012" to "This pair is fully served: the corpus holds plenty of sentences and the decks are large.",
	"cat.013" to "This pair is thin: the corpus holds few sentences, so the decks come out shorter. That is a limit of the source, not of the app.",
	"cat.014" to "Nothing for this pair yet. How well every pair is served is listed in the project README.",
	"cat.015" to "cards",
	"cat.016" to "Licence: ",
	"cat.017" to "Source: ",
	"cat.018" to "DOWNLOAD",
	"cat.019" to "DOWNLOADING",
	...
	"cat.028" to "middle",
	"cat.029" to "advanced",
	"cat.030" to "Nothing matches these filters.",
	...
	"cat.036" to "SHOW EXAMPLES",
	"cat.037" to "LOADING EXAMPLES…",
	"cat.038" to "RETRY EXAMPLES",
	"cat.039" to "EXAMPLES FROM THE DECK",
	"cat.040" to "CARD ",
	"cat.041" to "With pronunciation",
	"a11y.011" to "Search decks",
	"src.001" to "Source · ",
	"src.002" to "Is this card wrong?",
	"src.003" to "The card will be hidden and a paste-ready report with its text and source link copied. It can be pasted into GitHub Issues.",
	"src.004" to "HIDE AND COPY",
	"src.005" to "CANCEL",
	"src.006" to "Card hidden · report copied",
	"src.007" to "SOURCE",
	"search.001" to "Search decks",
	"search.002" to "Searches only decks already installed on this phone. No network is used.",
	"search.003" to "Phrase, sentence or translation",
	"search.004" to "SEARCH",
	"search.005" to "SEARCHING…",
	"search.006" to "Type at least two characters.",
	"search.007" to "Nothing found in the installed decks.",
	"search.008" to "The first 80 matches are shown — make the query more specific to narrow the list.",
	"search.009" to "Search did not complete. No data changed; it can be retried.",
	"search.010" to "DECK · ",
    ...
    "anki.011" to "Review events skipped: ",
    "anki.012" to "Suspended or buried in Anki, not added: ",
    "anki.013" to "Cards skipped: ",
    "anki.014" to "With pictures or sound: ",
    "anki.015" to "The history is very large: the newest 100,000 ratings were used.",
    "anki.016" to "DONE",
    ...
    "pc.001" to "Not available on the desktop yet",
    "pc.002" to "Space reveals, 1–4 grade, Z undoes",
    "pc.003" to "Session",
    "pc.004" to "Pick a deck on the left",
    "pc.005" to "File",
    "pc.006" to "View",
    "pc.007" to "Help",
    "pc.008" to "Quit",
    "pc.009" to "Full screen",
    "pc.010" to "Keyboard shortcuts",
    "pc.011" to "Data folder",
    "pc.012" to "Ikna is already running",
    "pc.013" to "Ikna hit an error. The details are in the log file:",
    "pc.014" to "Drag the card: left is do not know, right is know",
    "pc.015" to "Decks",
    "pc.016" to "Today",
    "pc.017" to "Minimize window",
    "pc.018" to "Maximize window",
    "pc.019" to "Restore window",
    "pc.020" to "Close window",
    "bk.001" to "ONE FILE",
    "bk.002" to "SAVE TO FILE",
    "bk.003" to "RESTORE FROM FILE",
    "bk.004" to "FILE FOR THE PHONE",
    "bk.005" to "WORKING…",
    "bk.006" to "Saved: ",
    "bk.007" to "Answers: ",
    "bk.008" to "Decks: ",
    "bk.009" to "Answers taken: ",
    "bk.010" to "Already here: ",
    "bk.011" to "Cards recomputed: ",
    "bk.012" to "Settings applied",
    "bk.013" to "File not read",
    "bk.014" to "Nothing to save",
    "bk.015" to "Read a full file",
    "bk.016" to "Answers, settings and deck texts — everything that cannot be made again.",
    "bk.017" to "Why there are no conflicts",
    "bk.018" to "The answer log is only ever appended to, and every answer is identified by its card and its time. Merging two logs is a union, so one file can travel between phone and computer as often as you like.",
    "bk.019" to "The restore on the phone reads these two files.",
    "bk.020" to "Read an answer log",
    "bk.021" to "Read settings",
    "bk.022" to "Read a deck",
    "bk.023" to "File: ",
    "bk.024" to "Size, MB: ",
    "grading.001" to "Derived grades · experimental",
    "grading.002" to "Off by default. Uses only your local timings after warm-up. Unproven benefit; intervals are bounded to ±30%. Required reveal never counts as an optional peek or evidence for Easy.",
    "optimizer.001" to "Local FSRS fitting",
    "optimizer.002" to "Checks recent recall predictions using only this device’s history, not personal memory constants.",
    "optimizer.003" to "Use the applied fit",
    "optimizer.004" to "Calculate from history",
    "optimizer.005" to "Cancel calculation",
    "optimizer.006" to "Apply saved result",
    "optimizer.007" to "No calculation yet.",
    "optimizer.008" to "Not enough history: {count} / 500 scored answers. Repeats under one day are not scored.",
    "optimizer.009" to "No improvement over defaults on recent history. This is normal, not your failure.",
    "optimizer.010" to "Better held-out predictions. Applying this result is a separate choice.",
    "optimizer.011" to "Calculating locally in the background. You may leave this screen.",
    "optimizer.012" to "Future answers only. Existing dates and history stay unchanged. Off restores defaults immediately.",
    "optimizer.013" to "Scored answers",
    "optimizer.014" to "Last calculation",
    "optimizer.015" to "Held-out loss: defaults / fit; lower is better",
    "optimizer.016" to "Next full calculation after {date}; at most every 30 days.",
    "optimizer.017" to "Cannot read or save the setting/result. No unvalidated weights were activated.",
    "optimizer.018" to "Calculation failed; the applied model is unchanged.",
    "optimizer.019" to "History changed during calculation. Nothing saved; try again.",
    "optimizer.020" to "Cancelled; saved result unchanged.",
    "optimizer.021" to "Standard FSRS weights are active.",
    "optimizer.022" to "The explicitly applied local fit is active.",
    ...
    "browse.001" to "BROWSE",
    "browse.002" to "SWIPE RIGHT →",
    "browse.003" to "That is all for today",
    "browse.004" to "Browse returns after the next daily plan.",
    "browse.005" to "NO RATING",
    "browse.006" to "Nothing to browse yet",
    "browse.007" to "Familiar cards will appear here after a few reviews.",
    "a11y.012" to "Browse deck",
    "a11y.013" to "Next card",
    "file.001" to "Replace the existing file?",
    "set.149" to "PORTUGUÊS (BRASIL)",
    "pseudo.001" to "Pseudolocalization",
    "pseudo.002" to "Expands interface text only to expose clipping and cramped layouts. Cards and decks stay unchanged.",
    "browse.008" to "Finish the whole daily plan first.",
    "browse.009" to "Browse allowance has not built up yet. Every three required cards from completed plans earn one Browse card.",
    "browse.010" to "This deck has no familiar cards yet. They appear after two successful reviews on different days.",
    "browse.011" to "Today's Browse ceiling is reached. It will be checked again after the next daily plan.",
    "browse.012" to "The night limit is active. Browse will be checked again after it ends.",
    "browse.013" to "The required review queue needs to shrink first. Browse will be checked again with the next daily plan.",
    "browse.014" to "After a break, regular reviews come first. Browse will be checked again with the next daily plan.",
    "browse.015" to "After several quiet days, a regular daily plan comes first. Browse will be checked again tomorrow.",
    "browse.016" to "Recent answers are not stable enough for Browse yet. Reinforce them in the regular mode first.",
    "browse.017" to "Return mode is active. Browse will be checked again with the next daily plan.",
    "browse.018" to "Today's load was already high. Browse will be checked again with the next daily plan.",
    "browse.019" to "A safety limit is active today. Browse will be checked again with the next daily plan.",
    "browse.020" to "Checking Browse availability…",
