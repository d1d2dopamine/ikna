...
val STRINGS_EN: Map<String, String> = mapOf(
    ...
    "browse.008" to "Finish today's daily plan first.",
    "browse.009" to "The required plan has fewer than three cards, so it does not open Browse.",
    "browse.010" to "This deck has no cards familiar enough for Browse yet.",
    "browse.011" to "Today's Browse limit has already been used.",
