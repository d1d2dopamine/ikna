...
val STRINGS_PL: Map<String, String> = mapOf(
    ...
    "pc.002" to "Spacja pokazuje odpowiedź, ←/→ odpowiadają, Z cofa",
    "pc.003" to "Sesja",
    ...
    "pc.015" to "Talie",
    "pc.016" to "Dzisiaj",
    "pc.017" to "Minimalizuj okno",
    "pc.018" to "Maksymalizuj okno",
    "pc.019" to "Przywróć rozmiar okna",
    "pc.020" to "Zamknij okno",
    ...
    "grading.001" to "Oceny wyliczane · eksperyment",
    "grading.002" to "Domyślnie wyłączone. Używa tylko lokalnych pomiarów po zebraniu historii. Korzyści niepotwierdzone; zmiana odstępu do ±30%. Wymagane odsłonięcie nie jest podpowiedzią ani podstawą oceny Łatwe.",
    "optimizer.001" to "Lokalne dopasowanie FSRS",
    "optimizer.002" to "Sprawdza prognozę przypominania tylko z lokalnej historii, nie stałe pamięci.",
    "optimizer.003" to "Używaj zastosowanego wyniku",
    "optimizer.004" to "Oblicz z historii",
    "optimizer.005" to "Anuluj obliczenia",
    "optimizer.006" to "Zastosuj wynik",
    "optimizer.007" to "Brak obliczeń.",
    "optimizer.008" to "Za mało historii: {count} / 500 ocenianych odpowiedzi. Powtórki przed dobą nie są oceniane.",
    "optimizer.009" to "Brak poprawy wobec standardu. To normalne, nie błąd użytkownika.",
    "optimizer.010" to "Lepsza prognoza części kontrolnej. Zastosowanie jest osobnym wyborem.",
    "optimizer.011" to "Obliczanie lokalne w tle. Możesz opuścić ekran.",
    "optimizer.012" to "Tylko przyszłe odpowiedzi. Daty i historia bez zmian. Wyłączenie przywraca standard.",
    "optimizer.013" to "Oceniane odpowiedzi",
    "optimizer.014" to "Ostatnie obliczenie",
    "optimizer.015" to "Strata kontrolna: standard / wynik; mniej = lepiej",
    "optimizer.016" to "Następne pełne obliczenie po {date}; raz na 30 dni.",
    "optimizer.017" to "Nie można odczytać lub zapisać wyniku. Nie włączono niesprawdzonych wag.",
    "optimizer.018" to "Obliczenie nieudane; model bez zmian.",
    "optimizer.019" to "Historia się zmieniła. Nic nie zapisano; spróbuj ponownie.",
    "optimizer.020" to "Anulowano; zapisany wynik bez zmian.",
    "optimizer.021" to "Aktywne standardowe wagi FSRS.",
    "optimizer.022" to "Aktywny zastosowany wynik lokalny.",
    ...
    "browse.001" to "PRZEGLĄDANIE",
    "browse.002" to "PRZESUŃ W PRAWO →",
    "browse.003" to "To wszystko na dziś",
    "browse.004" to "Przeglądanie wróci po następnym planie dnia.",
    "browse.005" to "BEZ OCENY",
    "browse.006" to "Na razie nie ma czego przeglądać",
    "browse.007" to "Znane karty pojawią się tutaj po kilku powtórkach.",
    "a11y.012" to "Przeglądaj talię",
    "a11y.013" to "Następna karta",
    "file.001" to "Nadpisać istniejący plik?",
    "set.149" to "PORTUGUÊS (BRASIL)",
    "pseudo.001" to "Pseudolokalizacja",
    "pseudo.002" to "Wydłuża tylko tekst interfejsu, aby ujawnić obcięcia i zbyt ciasny układ. Karty i talie pozostają bez zmian.",
    "browse.008" to "Najpierw ukończ cały dzisiejszy plan.",
    "browse.009" to "Limit przeglądania nie został jeszcze zgromadzony. Każde trzy obowiązkowe karty z ukończonych planów dają jedną kartę do przeglądania.",
    "browse.010" to "W tej talii nie ma jeszcze znanych kart. Pojawią się po dwóch udanych powtórkach w różne dni.",
    "browse.011" to "Dzisiejszy limit przeglądania został wykorzystany. Zostanie sprawdzony ponownie po następnym planie dnia.",
    "browse.012" to "Obowiązuje ograniczenie nocne. Przeglądanie zostanie sprawdzone ponownie po jego zakończeniu.",
    "browse.013" to "Najpierw trzeba zmniejszyć kolejkę obowiązkowych powtórek. Przeglądanie wróci do sprawdzenia z następnym planem.",
    "browse.014" to "Po przerwie pierwszeństwo mają zwykłe powtórki. Przeglądanie zostanie sprawdzone przy następnym planie.",
    "browse.015" to "Po kilku cichych dniach najpierw potrzebny jest zwykły plan dnia. Przeglądanie zostanie sprawdzone jutro.",
    "browse.016" to "Ostatnie odpowiedzi nie są jeszcze dość stabilne. Najpierw utrwal je w zwykłym trybie.",
    "browse.017" to "Aktywny jest tryb powrotu. Przeglądanie zostanie sprawdzone przy następnym planie.",
    "browse.018" to "Dzisiejsze obciążenie było już wysokie. Przeglądanie zostanie sprawdzone przy następnym planie.",
    "browse.019" to "Dziś działa ograniczenie ochronne. Przeglądanie zostanie sprawdzone przy następnym planie.",
    "browse.020" to "Sprawdzanie dostępności przeglądania…",
