...
val STRINGS_PL: Map<String, String> = mapOf(
    ...
    "browse.008" to "Najpierw ukończ dzisiejszy plan dnia.",
    "browse.009" to "Plan obowiązkowy ma mniej niż trzy karty, więc nie otwiera przeglądania.",
    "browse.010" to "W tej talii nie ma jeszcze kart wystarczająco dobrze znanych do przeglądania.",
    "browse.011" to "Dzisiejszy limit przeglądania został już wykorzystany.",
