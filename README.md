...
```
./gradlew assembleLiteDebug                        # the app
./gradlew assembleLiteRelease -Pikna.unsigned=true # unsigned, without the committed key
...
```
./gradlew assembleLiteDebug                        # приложение
./gradlew assembleLiteRelease -Pikna.unsigned=true # без коммитнутого ключа
